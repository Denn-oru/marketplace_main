...
urlpatterns=[
    ...
    path('login/', auth_views.LoginView.as_views(template_name='store/login-html', authentication_form=LoginForm)),
...
<div class="row p-4">
    <div class="col-6-bg-light p-4">
        ...
        <form action ="." method="POST">
            ...
            {% if form.errors of form.non_field_errors %}
